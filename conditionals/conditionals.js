...
let Abra = Math.floor(getRandomInt(3));
let Kadabra = Math.floor(getRandomInt(3));
let Alakazam = Math.floor(getRandomInt(3));
if( Abra > Kadabra && Abra > Alakazam){
   console.log("Abra" + " is the largest number");
}
else if( Kadabra > Abra && Kadabra> Alakazam){
   console.log("Kadabra" + " is the largest number");
}
else if( Alakazam > Kadabra && Alakazam > Abra){
   console.log("Alakazam" + " is the largest number");
}